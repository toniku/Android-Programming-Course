    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.wolf).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (option == "birds") {
                    mediaPlayer[0] = MediaPlayer.create(getApplicationContext(), R.raw.peippo_chaffinch);
                    mediaPlayer[0].start();
                }
        ...
        findViewById(R.id.elephant).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (option == "birds") {
                    mediaPlayer[0] = MediaPlayer.create(getApplicationContext(), R.raw.peukaloinen_wren);
                    mediaPlayer[0].start();
                }
        ...
        findViewById(R.id.lamb).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (option == "birds") {
                    mediaPlayer[0] = MediaPlayer.create(getApplicationContext(), R.raw.punatulkku_northern_bullfinch);
                    mediaPlayer[0].start();
                }
